...
def get_business_days_2024():
    """2024년 영업일 목록 생성 (주말 제외)"""
...
def main():
    print("=" * 60)
    print("2024년 주식 데이터 재수집 시작")
    print("=" * 60)

    # 영업일 목록 생성
    business_days = get_business_days_2024()
    total_days = len(business_days)
    print(f"\n📅 수집 대상: {total_days}개 영업일 (2024-01-01 ~ 2024-12-31)")
